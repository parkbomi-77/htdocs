...
$save_file = G5_DATA_PATH.'/cache/theme/'.$config['cf_theme'].'/maincategory.php';
...
<li class="gnb_1dli" style="z-index:<?php echo $gnb_zindex; ?>">
    <a href="<?php echo shop_category_url($key); ?>" class="gnb_1da<?php if ($count) echo ' gnb_1dam'; ?>"><?php echo $row['ca_name']; ?></a>
</li>
<?php
