...
if ( ! class_exists( 'Jet_Widgets_Shortcodes' ) ) {

	/**
	 * Define Jet_Widgets_Shortcodes class
	 */
	class Jet_Widgets_Shortcodes {
		...
		public function register_shortcodes() {
			...
			require jet_widgets()->plugin_path( 'includes/base/class-jet-widgets-shortcode-base.php' );

			foreach ( glob( jet_widgets()->plugin_path( 'includes/shortcodes/' ) . '*.php' ) as $file ) {
...
/**
 * Returns instance of Jet_Widgets_Shortcodes
 *
 * @return object
 */
function jet_widgets_shortocdes() {
	return Jet_Widgets_Shortcodes::get_instance();
}
