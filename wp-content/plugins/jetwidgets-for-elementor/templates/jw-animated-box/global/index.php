...
<div class="jw-animated-box <?php $this->__html( 'animation_effect', '%s' ); ?>">
	...
	<div class="jw-animated-box__back">
		...
		<div class="jw-animated-box__inner">
			<?php
				$this->_render_icon( 'back_side_icon', '<div class="jw-animated-box__icon jw-animated-box__icon--back"><div class="jw-animated-box-icon-inner"><span class="jet-widgets-icon">%s</span></div></div>' );
			?>
			<div class="jw-animated-box__content">
			<?php
